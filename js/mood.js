...
import { getFirestore, collection, addDoc, query, where, getDocs, orderBy } from "https://www.gstatic.com/firebasejs/9.1.3/firebase-firestore.js";
        ...
        if (jaiThoughts.length > 0) {
            jaiThoughts.forEach(thought => {
                ...
                resultItem.innerHTML = `
                    ...
                    <div class="thought-text">${thought.thought.replace(/<br>/g, '\n')}</div>`;
